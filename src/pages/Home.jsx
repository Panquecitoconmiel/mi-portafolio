        ...
        <div className="container">
          ...
          >
            {quickLinks.map((item, index) => (
              ...
              >
                {item.icon}
                <h3 style={{ fontSize: '1.3rem', fontWeight: '700', color: '#a61e4d' }}>
                  {item.title}
                </h3>
                <p style={{ color: '#a61e4d', opacity: 0.75, fontSize: '0.95rem' }}>
                  {item.text}
                </p>
              </Link>
            ))}
