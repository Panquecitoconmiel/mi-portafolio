      ...
      <div className="container">
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(320px, 1fr))', gap: '2.5rem', marginTop: '2.5rem' }}>
          {projectsData.map((project, index) => (
            ...
            >
              <h3 style={{ fontSize: '1.8rem', fontWeight: '700', color: '#1a1a1a', marginBottom: '0.8rem' }}>
                {project.title}
              </h3>
              <p style={{ color: '#1a1a1a', opacity: 0.8, marginBottom: '1.2rem', whiteSpace: 'pre-line' }}>
                {project.description}
              </p>
              ...
              <div style={{ display: 'flex', gap: '1.5rem', alignItems: 'center', flexWrap: 'wrap' }}>
                {project.isExternal ? (
                  ...
                  onMouseEnter={e => e.target.style.borderBottom = '2px solid #a1a1aa'} 
