      ...
      <div className="container" style={{ position: 'relative', zIndex: 2 }}>
        ...
        <div className="section-head" data-aos="fade-up">
          ...
          <h2 style={{ fontSize: '2.8rem', fontWeight: '700' }}>
            <FaRegEnvelope style={{ marginRight: '0.6rem', color: '#1a1a1a' }} />
            Contáctame
          </h2>
        </div>
        <p style={{ color: '#1a1a1a', opacity: 0.8, marginBottom: '2.5rem', fontSize: '1.1rem' }} data-aos="fade-up" data-aos-delay="100">
        ...
        <div style={{
          ...
          <form ref={form} onSubmit={sendEmail}>
            <div style={{ marginBottom: '1.5rem' }}>
              <label htmlFor="user_name" style={{ display: 'block', fontWeight: '600', color: '#1a1a1a', marginBottom: '0.5rem' }}>
              ...
              <input
                ...
                onBlur={e => e.target.style.borderColor = 'rgba(161, 161, 170, 0.5)'}
              />
            </div>

            <div style={{ marginBottom: '1.5rem' }}>
              <label htmlFor="user_email" style={{ display: 'block', fontWeight: '600', color: '#1a1a1a', marginBottom: '0.5rem' }}>
            ...
            <div style={{ marginBottom: '1.8rem' }}>
              <label htmlFor="message" style={{ display: 'block', fontWeight: '600', color: '#1a1a1a', marginBottom: '0.5rem' }}>
                Mensaje
              </label>
              <textarea
                id="message"
            ...
            <button
              ...
              style={{
                ...
                transition: '0.3s',
                boxShadow: '0 8px 25px rgba(26, 26, 26, 0.2)'
              }}
              onMouseEnter={e => {
                if (!isSending) {
                  e.target.style.transform = 'translateY(-2px)';
                  e.target.style.boxShadow = '0 12px 35px rgba(26, 26, 26, 0.3)';
                }
              }}
              onMouseLeave={e => {
                if (!isSending) {
