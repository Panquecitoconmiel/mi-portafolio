...
const cardStyle = {
  ...
  boxShadow: '0 15px 40px rgba(26, 26, 26, 0.08)',
...
const DevCard = ({ exp, index }) => (
  <div
    ...
    onMouseEnter={(e) => {
      ...
      e.currentTarget.style.boxShadow = '0 25px 50px rgba(26, 26, 26, 0.15)';
    }}
    onMouseLeave={(e) => {
      e.currentTarget.style.transform = 'translateX(0)';
      e.currentTarget.style.boxShadow = '0 15px 40px rgba(26, 26, 26, 0.08)';
    }}
  >
    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', minWidth: '100px', gap: '0.5rem' }}>
      <div style={{
        ...
        fontSize: '1.8rem',
        boxShadow: '0 8px 20px rgba(26, 26, 26, 0.2)',
      }}>
        <FaCode />
      </div>
      <div style={{
    ...
    <div style={{ flex: 1 }}>
      <h3 style={{ fontSize: '1.6rem', fontWeight: '700', color: '#1a1a1a', marginBottom: '0.2rem' }}>
        {exp.title}
      </h3>
      <p style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', color: '#1a1a1a', opacity: 0.7, marginBottom: '0.8rem', fontWeight: '500' }}>
        <FaBuilding /> {exp.company}
      </p>
      <p style={{ color: '#1a1a1a', opacity: 0.85, marginBottom: '1rem', whiteSpace: 'pre-line', lineHeight: '1.7' }}>
        {exp.description}
      </p>
  ...
  >
    ...
    <div style={{ flex: 1 }}>
      <div style={{ display: 'flex', flexWrap: 'wrap', gap: '0.6rem', alignItems: 'baseline', marginBottom: '0.3rem' }}>
        <h4 style={{ fontSize: '1.15rem', fontWeight: '700', color: '#1a1a1a' }}>{exp.title}</h4>
        <span style={{ color: '#1a1a1a', opacity: 0.6, fontSize: '0.9rem' }}>· {exp.company}</span>
      </div>
      <p style={{ fontSize: '0.85rem', fontWeight: '600', color: '#1a1a1a', opacity: 0.55, marginBottom: '0.5rem' }}>
        {exp.date}
      </p>
      <p style={{ color: '#1a1a1a', opacity: 0.8, fontSize: '0.95rem', lineHeight: '1.6' }}>
        {exp.description}
      </p>
    </div>
  </div>
  ...
  return (
    <section style={{
      ...
      <div style={{
        ...
        background: 'radial-gradient(circle, #a1a1aa, transparent 70%)',
      ...
      <div className="container" style={{ position: 'relative', zIndex: 2 }}>
        ...
        <p style={{ color: '#1a1a1a', opacity: 0.8, marginBottom: '3rem', fontSize: '1.1rem', maxWidth: '650px' }} data-aos="fade-up" data-aos-delay="100">
        ...
        <p style={{ color: '#1a1a1a', opacity: 0.8, marginBottom: '2.5rem', fontSize: '1.05rem', maxWidth: '650px' }} data-aos="fade-up" data-aos-delay="100">
